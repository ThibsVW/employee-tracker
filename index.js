...
function start() {
    inquirer
        ...
        .then(function (answer) {
            // based on their answer, call the following functions
...
function viewEmpRole() {
    inquirer
        ...
        .then(function (answer) {
            if (answer.role === "Fundraising Manager" || "Fundraising Assistant" || "Development Manager" || "Associate Development Manager" || "Lead Advisor" || "Associate Advisorr" || "Marketing Manager" || "Associate Marketing Manager") {
